...
public class MusicReferencesStandsForm extends javax.swing.JFrame {
    Connection connectionObj = null;
    PreparedStatement prepparedStatObj = null;
    ResultSet resultSetObj = null;
    JoJoMainClass joJoMainClassOjb = new JoJoMainClass();
    String populateTableSql = "SELECT * FROM Music_References_Stands";
    
    
    public MusicReferencesStandsForm() 
    {    
        initComponents(); 
    ...
    private void populateTableMethod()
    {
        ...
        {
            Logger.getLogger(MusicReferencesStandsForm.class.getName()).log(Level.SEVERE, null, ex);
        }       
    }
    ...
    private void initComponents() {
        ...
        referenceTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stand_Name_Reference ", "Song", "Album", "Performer", "Year"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(repopulateTableButton6, javax.swing.GroupLayout.PREFERRED_SIZE, 555, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addCharacterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCharacterActionPerformed
        ...
        String sqlInsertNewCharacter = "INSERT INTO Music_References_Stands(Stand_Name_Reference, Song, Album, Performer, Year) VALUES(?,?,?,?,?)";   
    ...
    private void acceptChangesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptChangesButtonActionPerformed
        ...
        String performerName = performerNameTextField.getText(); 
        int year = Integer.parseInt(yearTextField.getText());
        String sql = "UPDATE Music_References_Stands SET Stand_Name_Reference = ? , Song = ? , Album = ? , Performer = ? , Year = ? WHERE Reference_Name = ?";
        try
        {
            prepparedStatObj = connectionObj.prepareStatement(sql);
    ...
    private void removeCharacterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeCharacterButtonActionPerformed
        // TODO add your handling code here:       
        String sql = "DELETE FROM Music_References_Stands WHERE Stand_Name_Reference = ?";   
    ...
    private void sortButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortButtonActionPerformed
        ...
        String sqlSort = "SELECT * FROM Music_References_Stands GROUP BY " + selectedColumn;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        String sqlSearch = "SELECT * FROM Music_References_Stands WHERE " + searchedColumn + " LIKE ?";
...
try {
            ...
            String sql = "SELECT * FROM Music_References_Stands WHERE Stand_Name_Reference = '"+tableClick+"' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MusicReferencesStandsForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MusicReferencesStandsForm().setVisible(true);
            }
        });
    }
